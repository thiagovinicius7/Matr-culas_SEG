...
import { calculateAgeAtCutoff, getRegularClassForAgeDynamic, getContraturnoPriceDynamic, normalizeClassId, getFaseProcesso } from '../data';
...
export default function NegotiationCalc({
  ...
  const handleConfirm = () => {
    ...
    const faseJaAvancada = existingEnrollment && getFaseProcesso(existingEnrollment) !== 'preparo_terra';
    const faseProcesso: Enrollment['faseProcesso'] = faseJaAvancada
      ? getFaseProcesso(existingEnrollment!)
